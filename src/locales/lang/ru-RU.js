...
const locale = {
    ...
    'value': 'Значение',
    'info_user': 'Информация о клиенте',
    'info_courier': 'Информация о курье',
    'info_order': 'Информация о заказe',
    'info_delivery': 'Информация о доставкa',
    'name_user': 'Имя',
    'id': 'Ид',
    ...
    'order.delevered.list': 'Список доставки заказа',
    'total': 'Всего',
    'quantity': 'Количество',
