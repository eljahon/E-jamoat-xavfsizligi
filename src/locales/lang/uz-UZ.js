...
import momentRU from 'moment/locale/uz'
const components = {
  momentName: 'uz',
...
const locale = {
  'administrative_practice': 'Ma’muriy amaliyot',
  'dashboard': 'Bosh sahifa',
 'women_issues': 'Xotin-qizlar masalalari',
  'young_people': 'Voyaga yetmaganlar',
  'public': 'Jamoatchilik',
  'analysis': 'Tahlil',
  'category': 'Категория',
  ...
  'products': 'Продукты',
  'product': 'Продукт',
  'preventive_service': 'Profilaktik xizmat',
